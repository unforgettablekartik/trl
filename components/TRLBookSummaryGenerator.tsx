...
export default function TRLBookSummaryGenerator() {
  ...
  return (
    <>
      ...
      {showSummary && summary && (
        <div className="trl-summary-overlay" dir={isRtl ? 'rtl' : 'ltr'}>
          <div className="trl-summary-overlay__header">
            <Logo className="trl-summary-overlay__logo" />
            <button
              className="trl-summary-overlay__close"
          ...
          <div
            ref={summaryBlockRef}
            className="trl-prose no-copy trl-summary-overlay__body"
          ...
          >
            ...
            <div className="trl-summary-overlay__footer">
      ...
      <style jsx global>{`
        ...
        .trl-summary-overlay{ position:fixed; inset:0; background:#fff; z-index:70; overflow-y:auto; }
        .trl-summary-overlay__header{ position:sticky; top:0; left:0; display:flex; align-items:center; gap:8px; padding:16px; background:#fff; }
        .trl-summary-overlay__logo{ height:32px; width:auto; }
        .trl-summary-overlay__close{ background:none; border:none; font-size:24px; line-height:1; cursor:pointer; }
        .trl-summary-overlay__body{ padding:0 16px 40px; max-width:800px; margin:0 auto; }
        .trl-summary-overlay__footer{ margin-top:20px; display:flex; justify-content:center; }
