...
export const metadata: Metadata = {
  ...
  description:
    "The Reader’s Lawn — AI book summaries. Search any book or author and get a 3-paragraph (~2,000 words) summary with Reader’s Takeaway and three recommendations.",
  ...
  openGraph: {
    ...
    description:
      "Search any book or author and get a 3-paragraph (~2,000 words) summary with Reader’s Takeaway and three recommendations.",
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta
          name="description"
          content="The Reader’s Lawn — AI book summaries. Search any book or author and get a 3-paragraph (~2,000 words) summary with Reader’s Takeaway and three recommendations."
        />
      </head>
      <body>
        {children}
